...
<head>
    ...
    <title>Dany Eliezer <?php echo date("d-m-Y"); ?></title>
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">Daniel Tienda</a>
        ...
        <div class="card-group">
            <div class="card border" style="margin-right: 5px;">
                <center>
                    ...
                    <div class="card-body">
                        <h5 class="form-control">Login Usuario</h5>
                        <p><button data-bs-toggle="modal" data-bs-target="#modal_login_user"
                                class="btn btn-dark">Ingresar</button></p>
            ...
            <div class="card border">
                <center>
                    ...
                    <div class="card-body">
                        <h5 class="form-control">Login Administrador</h5>
                        <p><button data-bs-toggle="modal" data-bs-target="#modal_login_admin"
                                class="btn btn-danger">Ingresar</button></p>
                    </div>
                </center>
            </div>
        </div>
    ...
    <div class="alert alert-dismissible alert-danger fade" id="error_alert"
        style="position: fixed; top: 13%; right: 0; z-index: 14000;">
